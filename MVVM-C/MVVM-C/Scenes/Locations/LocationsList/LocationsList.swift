...
final class LocationsList: UIViewController {
    ...
    private lazy var tableView: UITableView = {
        ...
        tableView.register(
            LocationCell.classForCoder(),
            forCellReuseIdentifier: String(describing: LocationCell.self)
        )
        tableView.register(
...
extension LocationsList: UITableViewDelegate {
...
extension LocationsList: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: String(describing: LocationCell.self), for: indexPath) as! LocationCell
        
        if let viewModel = viewModel.viewModelFor(row: indexPath.row) as? LocationCellViewModel {
...
extension LocationsList: ListViewModelDelegate {
